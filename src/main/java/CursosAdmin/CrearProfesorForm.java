 ...
 */
public class CrearProfesorForm extends javax.swing.JFrame {
    public ArrayList<Profesor> profesores = new ArrayList<>();
    public Profesor editarProfesor;
    public Integer index = null;
    /**
     * Creates new form CrearProfesorForm
     */
    public CrearProfesorForm(ArrayList<Profesor> profesores) {
        initComponents();
        this.profesores = profesores;
    }
    
    public CrearProfesorForm(ArrayList<Profesor> profesores, int index) {
        initComponents();
        this.jButtonCrear.setText("editar");
        this.jLabel1.setText("Editar profesor");
        this.profesores = profesores;
        this.jTextUsuario.setEditable(false);
        this.index = index;
        this.editarProfesor = this.profesores.get(this.index);
        jTextNombre.setText(this.editarProfesor.nombre);
        jTextApellido.setText(this.editarProfesor.apellido);
        jTextPassword.setText(this.editarProfesor.password);
        jTextUsuario.setText(Integer.toString(this.editarProfesor.usuario));
    }
    ...
    private void jButtonCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCrearActionPerformed
        ...
        int usuario = Integer.parseInt(jTextUsuario.getText());
        System.out.println(this.index);
        if(this.index != null) {
            this.editarProfesor.nombre = nombre;
            this.editarProfesor.apellido = apellido;
            this.editarProfesor.password = password;
            JOptionPane.showMessageDialog(this, "Profesor editado correctamente");
        } else {
            Profesor nuevoProf = new Profesor(usuario, nombre, apellido, password);
            this.profesores.add(nuevoProf);
            jTextNombre.setText("");
